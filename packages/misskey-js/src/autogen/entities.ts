...
export type EndpointsNotesMakePrivateManyCountRequest = operations['endpoints___notes___make-private-many-count']['requestBody']['content']['application/json'];
export type EndpointsNotesMakePrivateManyCountResponse = operations['endpoints___notes___make-private-many-count']['responses']['200']['content']['application/json'];
...
export type NotesMakePrivateRequest = operations['notes___make-private']['requestBody']['content']['application/json'];
export type NotesMakePrivateManyRequest = operations['notes___make-private-many']['requestBody']['content']['application/json'];
...
export type StpvReactionsStatRequest = operations['stpv___reactions-stat']['requestBody']['content']['application/json'];
export type StpvReactionsStatResponse = operations['stpv___reactions-stat']['responses']['200']['content']['application/json'];
