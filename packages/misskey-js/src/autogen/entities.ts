...
export type NotesMakePrivateManyCountRequest = operations['notes___make-private-many-count']['requestBody']['content']['application/json'];
export type NotesMakePrivateManyCountResponse = operations['notes___make-private-many-count']['responses']['200']['content']['application/json'];
