...
<MkFolder>
	<template #label>
		...
		<span v-else-if="log.type === 'makePrivateNote'">: @{{ log.info.noteUserUsername }}{{ log.info.noteUserHost ? '@' + log.info.noteUserHost : '' }}</span>
	...
	<template #icon>
		...
		<i v-else-if="log.type === 'makePrivateNote'" class="ti ti-eye-exclamation"></i>
