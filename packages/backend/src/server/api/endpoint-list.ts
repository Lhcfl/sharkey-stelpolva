...
// STPV START
export * as 'stpv/reactions-stat' from './endpoints/stpv/reactions-stat.js';
...
export * as 'endpoints/notes/make-private-many-count' from './endpoints/notes/make-private-many-count.js';
// STPV END
