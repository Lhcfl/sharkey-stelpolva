...
<div :class="[$style.root, { [$style.collapsed]: collapsed }]">
	<div :class="{ [$style.clickToOpen]: defaultStore.state.clickToOpen }" @click.stop="defaultStore.state.clickToOpen ? noteclick(note.id) : undefined">
		...
		<Mfm v-if="note.text" :text="note.text" :lang="note.lang" :isBlock="true" :author="note.user" :nyaize="'respect'" :isAnim="allowAnim" :emojiUrls="note.emojis"/>
		...
		<div v-if="note.text && translating || note.text && translation" :class="$style.translation">
			...
			<div v-else>
				...
				<Mfm :text="translation.text" :lang="nativeLang" :isBlock="true" :author="note.user" :nyaize="'respect'" :emojiUrls="note.emojis"/>
			</div>
		</div>
