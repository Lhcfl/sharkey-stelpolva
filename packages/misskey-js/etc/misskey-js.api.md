...
// @public (undocumented)
type EndpointsNotesMakePrivateManyCountRequest = operations['endpoints___notes___make-private-many-count']['requestBody']['content']['application/json'];

// @public (undocumented)
type EndpointsNotesMakePrivateManyCountResponse = operations['endpoints___notes___make-private-many-count']['responses']['200']['content']['application/json'];
