export class StpvAddPgroonga1727538349223 {
	...
	async up(queryRunner) {
		await queryRunner.query(
			`CREATE INDEX IF NOT EXISTS "IDX_stpv_pgroonga_note_text" ON "note" USING "pgroonga" ("text")`,
		);
		await queryRunner.query(
		...
		await queryRunner.query(
			`CREATE INDEX IF NOT EXISTS "IDX_stpv_pgroonga_user_name" ON "user" USING "pgroonga" ("name" pgroonga_varchar_full_text_search_ops_v2)`,
		);
	}
